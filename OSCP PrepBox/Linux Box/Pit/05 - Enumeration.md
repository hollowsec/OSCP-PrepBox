...
* port 80 : nginx ("RED HAT" - IS CentOS (CentOS is the "free version" of red hat) )

* Port 9090 (CentOS Linux)
* DNS: dms-pit.htb 


# Nmap
```sql
# Nmap 7.92 scan initiated Mon Dec 27 19:32:45 2021 as: nmap -sC -sV -oA nmap/initial 10.10.10.241
Nmap scan report for 10.10.10.241
Host is up (0.19s latency).
Scanned at 2021-12-27 19:32:47 -03 for 228s
...
SF-Port9090-TCP:V=7.92%T=SSL%I=7%D=12/27%Time=61CA3F5E%P=x86_64-pc-linux-g
...
# Nmap done at Mon Dec 27 19:36:36 2021 -- 1 IP address (1 host up) scanned in 230.58 seconds

```

### UDP ports
```sql
# Nmap 7.92 scan initiated Mon Dec 27 19:59:07 2021 as: nmap -sUCV -oA nmap/udp-pit -v 10.10.10.241
Increasing send delay for 10.10.10.241 from 400 to 800 due to 11 out of 11 dropped probes since last increase.
Increasing send delay for 10.10.10.241 from 800 to 1000 due to 11 out of 31 dropped probes since last increase.
...
Read data files from: /usr/bin/../share/nmap
Service detection performed. Please report any incorrect results at https://nmap.org/submit/ .
# Nmap done at Mon Dec 27 20:24:14 2021 -- 1 IP address (1 host up) scanned in 1507.42 seconds

```

# ffuf
```bash
$ ffuf -u https://dms-pit.htb:9090/FUZZ -w /opt/SecLists/Discovery/Web-Content/raft-medium-words.txt -c -fs 43548,0
