...
[PayloadsAllTheThings / File Inclusion/ phpinfolfi.py](https://github.com/swisskyrepo/PayloadsAllTheThings/blob/master/File%20Inclusion/phpinfolfi.py)

Using php reverse shell for payload in phpinfolfi.py, with some edits.
...
def main():
    ...
    try:
        ...
        print("Error with poolsz %: %s" % (sys.argv[3], e))
        sys.exit(1)
...
```bash
$ python2 lfi.py 10.10.10.84 80 100
...
![[Pasted image 20211107223917.png]]

## Another way is dencoded the content  on [pwdbackup.txt](http://10.10.10.84/pwdbackup.txt)
...
Can login in to ssh with these creds
...
![[Pasted image 20211107225615.png]]